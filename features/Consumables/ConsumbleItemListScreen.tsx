...
import ConsumablesPurchaseLogModal from "./PurchaseLogs/Modal";
import { apiFetch } from "../../services/apiFetch";


export default function ConsumableListScreen() {
    ...
    const getConsumablesData = async() => {
        const data: any = await apiFetch('bio-materials', 'GET', token)
        setConsumables(data)
    }
