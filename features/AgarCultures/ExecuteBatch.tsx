...
import * as Agar from './../../data/db/agar-cultures'
import * as Usage from './../../data/db/usage_logs'
import * as Task from './../../data/db/tasks'
import { convertToBase } from "../../../mycologger-0.0.1/src/utils/unitConversion";
            ...
            <ScreenPrimative contentContainerStyle={styles.container} edges={[]}>
                <Surface style={styles.surfaceMetaContainer}>                        
                    <Surface style={styles.surfaceContainer}>
                        ...
                        <Text style={styles.subtitle}>(Agar Culture)</Text>        
                    </Surface>
                    <Surface style={styles.surfaceContainer}>
