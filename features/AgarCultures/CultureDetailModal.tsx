...
import * as Sterile from './../../data/db/sterilizations'
import * as Germ from './../../data/db/germinations'
import * as Inoc from './../../data/db/inoculations'
import * as Contam from './../../data/db/contaminations'
import * as Colony from './../../data/db/colonizations'
import * as Harvest from './../../data/db/harvests'
...
export const CultureDetailModal = ({ visible, setModalOpen, item}) => {
    ...
    const [germed, setGermed] = useState({});
    ...
    const getItemData = async() => {
        ...
        setHarvest(item.harvest_id ? await Harvest.getById(db, item.harvest_id) : null)
