...
import CreateHardwareItemPurchase from "../../components/forms/CreateHardwareItemPurchase";



export default function NewHardwarePurchaseLogScreen() {
    ...
    const getItemNames = async() => {
        const items = await Hardware.readAll(db)
