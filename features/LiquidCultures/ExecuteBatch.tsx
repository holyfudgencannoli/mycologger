...
import * as Liquid from './../../data/db/liquid-cultures'


export default function ExecuteLiquidBatch({id}: {id?: number}) {  
    ...
    const handleExecute = async () => {
        ...
        try {
            const creations = Array.from({ length: qty }, async () => {
                const cultureId = await Culture.create(db, 'liquid_cultures', new Date().getTime());
            ...
            <ScreenPrimative contentContainerStyle={styles.container} edges={[]}>
                <Surface style={styles.surfaceMetaContainer}>                        
                    <Surface style={styles.surfaceContainer}>
                        ...
                        <Text style={styles.subtitle}>(Liquid Culture)</Text>        
                    </Surface>
                    <Surface style={styles.surfaceContainer}>
