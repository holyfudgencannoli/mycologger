...
// const SomeForm = ({value: value, onChange: onChange, options: options, placeholder:placeholder}) => {
const SomeForm = () => {
...
export default function CreateNewProductBatch() {
    ...
    const handleSubmit = async () => {
        ...
        const res = await fetch("http://10.0.0.45:5000/api/products/batches", {
            method: 'POST',
            headers: {
                    ...
                    <Surface style={styles.surfaceMetaContainer}>                        
                        <Surface style={styles.surfaceContainer}>
                            <Surface style={styles.surface}>
                                <Text style={styles.title}>New Field Recipe</Text>        
