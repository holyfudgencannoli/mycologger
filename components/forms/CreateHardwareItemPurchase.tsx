...
import { MeasuringUnitAutocomplete } from "../MeasuringUnitAutoComplete";
...
import * as Hardware from './../../data/db/hardware-items'
...
export default function CreateHardwareItemPurchase({
    name,
    category,
    subcategory,
    setCategory,
    ...
    const handleSubmit = async () => {
        ...
        const invItemId = await InvItem.create(db, 'hardware_item', created_at)
        const hardwareId = await Hardware.create(db, invItemId, name, category, subcategory)
        ...
        await InvLog.create(
            ...
            'hardware_item',
            hardwareId,
            parseFloat(purchaseQuantity) * parseFloat(inventoryQuantity),
            inventoryUnit,
            created_at
        )
        return {invItemId, hardwareId}
    }
    ...
    return (
        <Surface style={styles.surfaceMetaContainer}>                        
            <Surface style={styles.surfaceContainer}>
                    ...
                    <Text style={styles.subtitle}>(Hardware & Tools)</Text>        
            </Surface>
